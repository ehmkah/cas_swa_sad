...
Mit der Die Kreditkarte dient der Information, falls es Probleme mit der Abrechnung gibt.
...
//ye: wollen wir hier Transfer Object, Adapter und DAO Muster auch erwähnen?
