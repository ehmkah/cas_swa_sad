...
=== Drucken
OTS generiert die Tickets als PDF-Dokument, welche zu einem späteren Zeitpunkt mit einem gewöhlichen PDF-Viewer oder direkt aus dem Browser ausgedruckt werden können. Das Drucken ist nicht Bestandteil des OTS-systems.
