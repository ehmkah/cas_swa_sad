...
===== Mengengerüste
* Das System muss 12000 E-Mails pro Tag verarbeiten und versenden können.
(Annahme 2 Performances pro Tag mit 15000 Plätzen und durchschnittlich 2.5 Karten pro Bestellung)
* Unter Hochlast muss das System muss bis zu 12000 Mails innerhalb von 10min entgegennehmen können,
