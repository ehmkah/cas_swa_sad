...
| Mutationen müssen zwingend protokollieren werden.
...
==== Technische Randbedingungen (z.B. Applikationsplattform, Referenzarchitektur)
...
| -
| -
| Die Protokollierung soll einen möchlichst kleinen Performanceimpact auf die Fachapplikation haben.
...
| -
| -
| Automatische Prozesse werden nicht protokolliert
...
Erhöhte Komplexität, erschwert die Auswertung und das Löschen der Protokollierungsdaten.
Kaum Vorteile gegenüber einer zentralen Datenbank
...
Wir gehen davon aus, dass der Datenschutzbeauftragte nicht über die Notwendigen Kenntnisse verfügt.
