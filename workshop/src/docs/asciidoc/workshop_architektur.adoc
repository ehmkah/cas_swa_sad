...
|===
1.4+| **FA-10 **
| *Protokollierungsdaten (Anfragetation) ID*
| Protokolleintrag muss im System eindeutig identifizierbar sein
| Benutzer müssen eindeutig identifizierbar sein
| Zeitpunkt und Art der Bearbeitung müssen erfasst werden
|===
