...
* Performanz und erfügbarkeit sind wichtige Architekturziele, darum werden sie mit 5 gewichtet.
* Skalierbarkeit, Integrierbarkeit, Sicherheit, Batchprozesse und  werden mit 4 gewichtet, weil sie integrale Bestandteile der Nicht-Funktionalen Anforderungen sind.
...
* Die Software wird nicht ständig erweitert, somit wird die Erweiterbarkeit mit 3 bewerte.
