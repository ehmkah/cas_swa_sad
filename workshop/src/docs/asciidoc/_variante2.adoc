...
Die Bibliothek wird wie alle Anwendungen mit Java entwickelt und als JAR via Maven importiert.
...
Die Kommunikation zwischen der Webanwendung und dem Backend erfolgt via _REST_.
...
- Die Bibliothek muss in jede Anwendung eingefügt werden.
