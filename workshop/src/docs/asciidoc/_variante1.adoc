...
Bei dieser Variante werden alle Anfragen durch einen Proxy vor der Fachapplkation abgegriffen.
...
Die Kommunikation erfolgt zwischen Webanwendung und Backend mit _REST_. Damit ersparen wir uns,
